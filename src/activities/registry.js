...
/** @typedef {{ lesson: Lesson, container: HTMLElement, speak: (text: string) => Promise<void>, onComplete: (result: ScoreResult) => void, showToast: (msg: string, type?: string) => void }} ActivityContext */
